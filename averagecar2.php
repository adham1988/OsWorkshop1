...
$sql = "SELECT carID, AVG(speed) AS 'AVERAGE SPEED' FROM car WHERE carID = 2";
$result = $conn->query($sql);
?>

<html>
<head>
      <title>Car2 Speed average</title>
   </head>
    <h1 align="center">CAR ID 2 Speed AVG</h1>
...
<br></br>
<div id="button"><a href="car2.php"= 1">Car ID = 2</a></div>
